...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 02 avr. 2025 à 17:09
...
(16, 'matthieuperry94@gmail.com', '$2y$10$VtzCmuHPYnvIk1hhT2Z18OUD8AKyswyVv0csqEsSSN93xP28.Sjvq', 'matthieuperry94');
...
--
ALTER TABLE `annonces`
  ADD CONSTRAINT `relation` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
